...
@c = global i8* null
@3 = private unnamed_addr constant [6 x i8] c"sodas\00", align 1
@4 = private unnamed_addr constant [7 x i8] c"sodas\0A\00", align 1
...
entry:
  ...
  %printf = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @4, i32 0, i32 0))
  %a = load i8*, i8** @a
