...
@1 = private unnamed_addr constant [30 x i8] c"three point one four one five\00", align 1
@2 = private unnamed_addr constant [31 x i8] c"three point one four one five\0A\00", align 1
@3 = private unnamed_addr constant [3 x i8] c"3\0A\00", align 1
@4 = private unnamed_addr constant [3 x i8] c"1\0A\00", align 1
@a = global i32 0
...
entry:
  ...
  %printf1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @2, i32 0, i32 0))
  %printf2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @3, i32 0, i32 0))
  %printf3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @4, i32 0, i32 0))
  store i32 10, i32* @a
  %a = load i32, i32* @a
  ...
  store i8* getelementptr inbounds ([7 x i8], [7 x i8]* @5, i32 0, i32 0), i8** @c
  %c = load i8*, i8** @c
