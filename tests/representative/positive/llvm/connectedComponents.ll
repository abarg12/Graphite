...
@lst1 = global %list_node* null
@lst2 = global %list_node* null
@edgesList = global %list_node* null
@llEdges = global %edge_node* null
@isConnected = global i1 false
@3 = private unnamed_addr constant [49 x i8] c"lists SHOULD be connected Printing if it is now\0A\00", align 1
...
merge202:                                         ; preds = %else201, %if200
  ...
  %n5 = load %node_struct*, %node_struct** @n5, align 8
  ...
  store %node_struct* %n5, %node_struct** %node_ptr246, align 8
  ...
  %nodes248 = getelementptr inbounds %graph_tt, %graph_tt* %graph_ptr247, i32 0, i32 0
  %nodes_hd249 = load %node_node*, %node_node** %nodes248, align 8
  %malloccall250 = tail call i8* @malloc(i32 ptrtoint (%node_node* getelementptr (%node_node, %node_node* null, i32 1) to i32))
  %new_node251 = bitcast i8* %malloccall250 to %node_node*
  %"lst_rst'252" = getelementptr inbounds %node_node, %node_node* %new_node251, i32 0, i32 1
  %node_ptr253 = getelementptr inbounds %node_node, %node_node* %new_node251, i32 0, i32 0
  store %node_node* %nodes_hd249, %node_node** %"lst_rst'252", align 8
  store %node_struct* %n6, %node_struct** %node_ptr253, align 8
  store %node_node* %new_node251, %node_node** %nodes248, align 8
  %malloccall254 = tail call i8* @malloc(i32 ptrtoint (%list_node** getelementptr (%list_node*, %list_node** null, i32 1) to i32))
  %new_list = bitcast i8* %malloccall254 to %list_node**
  store %list_node* null, %list_node** %new_list, align 8
  %n1255 = load %node_struct*, %node_struct** @n1, align 8
  %malloccall256 = tail call i8* @malloc(i32 ptrtoint (%node_struct** getelementptr (%node_struct*, %node_struct** null, i32 1) to i32))
  %arr_val = bitcast i8* %malloccall256 to %node_struct**
  store %node_struct* %n1255, %node_struct** %arr_val, align 8
  %i8ptr = bitcast %node_struct** %arr_val to i8*
  %malloccall257 = tail call i8* @malloc(i32 ptrtoint (%list_node* getelementptr (%list_node, %list_node* null, i32 1) to i32))
  %node_p = bitcast i8* %malloccall257 to %list_node*
  ...
  %n3258 = load %node_struct*, %node_struct** @n3, align 8
  %malloccall259 = tail call i8* @malloc(i32 ptrtoint (%node_struct** getelementptr (%node_struct*, %node_struct** null, i32 1) to i32))
  %arr_val260 = bitcast i8* %malloccall259 to %node_struct**
  store %node_struct* %n3258, %node_struct** %arr_val260, align 8
  %i8ptr261 = bitcast %node_struct** %arr_val260 to i8*
  ...
  %temp265 = getelementptr inbounds %list_node, %list_node* %node_p, i32 0, i32 1
  store %list_node* %node_p263, %list_node** %temp265, align 8
  %n4266 = load %node_struct*, %node_struct** @n4, align 8
  %malloccall267 = tail call i8* @malloc(i32 ptrtoint (%node_struct** getelementptr (%node_struct*, %node_struct** null, i32 1) to i32))
  %arr_val268 = bitcast i8* %malloccall267 to %node_struct**
  store %node_struct* %n4266, %node_struct** %arr_val268, align 8
  %i8ptr269 = bitcast %node_struct** %arr_val268 to i8*
  %malloccall270 = tail call i8* @malloc(i32 ptrtoint (%list_node* getelementptr (%list_node, %list_node* null, i32 1) to i32))
  %node_p271 = bitcast i8* %malloccall270 to %list_node*
  %valloc272 = getelementptr inbounds %list_node, %list_node* %node_p271, i32 0, i32 0
  store %list_node zeroinitializer, %list_node* %node_p271, align 8
  store i8* %i8ptr269, i8** %valloc272, align 8
  %temp273 = getelementptr inbounds %list_node, %list_node* %node_p263, i32 0, i32 1
  store %list_node* %node_p271, %list_node** %temp273, align 8
  %temp274 = load %list_node*, %list_node** %new_list, align 8
  store %list_node* %temp274, %list_node** @lst1, align 8
  %malloccall275 = tail call i8* @malloc(i32 ptrtoint (%list_node** getelementptr (%list_node*, %list_node** null, i32 1) to i32))
  %new_list276 = bitcast i8* %malloccall275 to %list_node**
  store %list_node* null, %list_node** %new_list276, align 8
  %n2277 = load %node_struct*, %node_struct** @n2, align 8
  %malloccall278 = tail call i8* @malloc(i32 ptrtoint (%node_struct** getelementptr (%node_struct*, %node_struct** null, i32 1) to i32))
  %arr_val279 = bitcast i8* %malloccall278 to %node_struct**
  store %node_struct* %n2277, %node_struct** %arr_val279, align 8
  %i8ptr280 = bitcast %node_struct** %arr_val279 to i8*
  %malloccall281 = tail call i8* @malloc(i32 ptrtoint (%list_node* getelementptr (%list_node, %list_node* null, i32 1) to i32))
  %node_p282 = bitcast i8* %malloccall281 to %list_node*
  %valloc283 = getelementptr inbounds %list_node, %list_node* %node_p282, i32 0, i32 0
  store %list_node zeroinitializer, %list_node* %node_p282, align 8
  store i8* %i8ptr280, i8** %valloc283, align 8
  store %list_node* %node_p282, %list_node** %new_list276, align 8
  %n5284 = load %node_struct*, %node_struct** @n5, align 8
  %malloccall285 = tail call i8* @malloc(i32 ptrtoint (%node_struct** getelementptr (%node_struct*, %node_struct** null, i32 1) to i32))
  %arr_val286 = bitcast i8* %malloccall285 to %node_struct**
  store %node_struct* %n5284, %node_struct** %arr_val286, align 8
  %i8ptr287 = bitcast %node_struct** %arr_val286 to i8*
  %malloccall288 = tail call i8* @malloc(i32 ptrtoint (%list_node* getelementptr (%list_node, %list_node* null, i32 1) to i32))
  %node_p289 = bitcast i8* %malloccall288 to %list_node*
  %valloc290 = getelementptr inbounds %list_node, %list_node* %node_p289, i32 0, i32 0
  store %list_node zeroinitializer, %list_node* %node_p289, align 8
  store i8* %i8ptr287, i8** %valloc290, align 8
  %temp291 = getelementptr inbounds %list_node, %list_node* %node_p282, i32 0, i32 1
  store %list_node* %node_p289, %list_node** %temp291, align 8
  %n6292 = load %node_struct*, %node_struct** @n6, align 8
  %malloccall293 = tail call i8* @malloc(i32 ptrtoint (%node_struct** getelementptr (%node_struct*, %node_struct** null, i32 1) to i32))
  %arr_val294 = bitcast i8* %malloccall293 to %node_struct**
  store %node_struct* %n6292, %node_struct** %arr_val294, align 8
  %i8ptr295 = bitcast %node_struct** %arr_val294 to i8*
  ...
  %temp299 = getelementptr inbounds %list_node, %list_node* %node_p289, i32 0, i32 1
  store %list_node* %node_p297, %list_node** %temp299, align 8
  %temp300 = load %list_node*, %list_node** %new_list276, align 8
  store %list_node* %temp300, %list_node** @lst2, align 8
  %lst2 = load %list_node*, %list_node** @lst2, align 8
  %lst1 = load %list_node*, %list_node** @lst1, align 8
  %disconnectedComponents_result = call i1 @disconnectedComponents(%list_node* %lst1, %list_node* %lst2)
  store i1 %disconnectedComponents_result, i1* @isConnected, align 1
  %printf = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([49 x i8], [49 x i8]* @3, i32 0, i32 0))
  %isConnected = load i1, i1* @isConnected, align 1
  %printf301 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @fmt, i32 0, i32 0), i1 %isConnected)
  ret i32 0
}
...
define i1 @disconnectedComponents(%list_node* %nodes11, %list_node* %nodes22) {
entry:
  %nodes1 = alloca %list_node*, align 8
  store %list_node* %nodes11, %list_node** %nodes1, align 8
  %nodes2 = alloca %list_node*, align 8
  store %list_node* %nodes22, %list_node** %nodes2, align 8
  %list = load %list_node*, %list_node** %nodes1, align 8
  %malloccall = tail call i8* @malloc(i32 ptrtoint (%list_node** getelementptr (%list_node*, %list_node** null, i32 1) to i32))
  ...
  %1 = bitcast i8* %malloccall3 to i32*
  store i32 0, i32* %1, align 4
  store %list_node* %list, %list_node** %0, align 8
  %2 = icmp eq %list_node* %list, null
...
traverse_loop:                                    ; preds = %while_body, %else
  ...
  br i1 %8, label %while_body, label %merge5

while_body:                                       ; preds = %traverse_loop
  %9 = load %list_node*, %list_node** %0, align 8
  %temp = getelementptr inbounds %list_node, %list_node* %9, i32 0, i32 1
  %temp4 = load %list_node*, %list_node** %temp, align 8
  %10 = load i32, i32* %1, align 4
  %add = add i32 %10, 1
  store i32 %add, i32* %1, align 4
  store %list_node* %temp4, %list_node** %0, align 8
  br label %traverse_loop

merge5:                                           ; preds = %traverse_loop
  br label %merge

merge9:                                           ; preds = %merge17, %then10
  %11 = load i32, i32* %5, align 4
  %lengthN2 = alloca i32, align 4
  store i32 %11, i32* %lengthN2, align 4
  %connection = alloca i1, align 1
  store i1 false, i1* %connection, align 1
  %index1 = alloca i32, align 4
  store i32 0, i32* %index1, align 4
  %index2 = alloca i32, align 4
  store i32 0, i32* %index2, align 4
  store i32 0, i32* %index1, align 4
  br label %while
...
traverse_loop12:                                  ; preds = %while_body13, %else11
  %12 = load %list_node*, %list_node** %4, align 8
  %13 = icmp ne %list_node* %12, null
  br i1 %13, label %while_body13, label %merge17

while_body13:                                     ; preds = %traverse_loop12
  %14 = load %list_node*, %list_node** %4, align 8
  %temp14 = getelementptr inbounds %list_node, %list_node* %14, i32 0, i32 1
  %temp15 = load %list_node*, %list_node** %temp14, align 8
  %15 = load i32, i32* %5, align 4
  %add16 = add i32 %15, 1
  store i32 %add16, i32* %5, align 4
  store %list_node* %temp15, %list_node** %4, align 8
  br label %traverse_loop12

merge17:                                          ; preds = %traverse_loop12
  br label %merge9

while:                                            ; preds = %merge57, %merge9
  %index160 = load i32, i32* %index1, align 4
  %lengthN161 = load i32, i32* %lengthN1, align 4
  %tmp62 = icmp slt i32 %index160, %lengthN161
  br i1 %tmp62, label %while_body18, label %merge63

while_body18:                                     ; preds = %while
  %list19 = load %list_node*, %list_node** %nodes1, align 8
  %index120 = load i32, i32* %index1, align 4
  %malloccall21 = tail call i8* @malloc(i32 ptrtoint (%list_node** getelementptr (%list_node*, %list_node** null, i32 1) to i32))
  %16 = bitcast i8* %malloccall21 to %list_node**
  %malloccall22 = tail call i8* @malloc(i32 ptrtoint (i32* getelementptr (i32, i32* null, i32 1) to i32))
  %17 = bitcast i8* %malloccall22 to i32*
  store %list_node* %list19, %list_node** %16, align 8
  store i32 %index120, i32* %17, align 4
  br label %traverse_loop23

traverse_loop23:                                  ; preds = %while_body24, %while_body18
  %18 = load i32, i32* %17, align 4
  %temp27 = icmp ne i32 %18, 0
  br i1 %temp27, label %while_body24, label %merge28

while_body24:                                     ; preds = %traverse_loop23
  %19 = load %list_node*, %list_node** %16, align 8
  %temp25 = getelementptr inbounds %list_node, %list_node* %19, i32 0, i32 1
  %temp26 = load %list_node*, %list_node** %temp25, align 8
  %20 = load i32, i32* %17, align 4
  %subtract = sub i32 %20, 1
  store i32 %subtract, i32* %17, align 4
  store %list_node* %temp26, %list_node** %16, align 8
  br label %traverse_loop23

merge28:                                          ; preds = %traverse_loop23
  %21 = load %list_node*, %list_node** %16, align 8
  %temp29 = getelementptr inbounds %list_node, %list_node* %21, i32 0, i32 0
  ...
  %nn1 = alloca %node_struct*, align 8
  store %node_struct* %val_ptr, %node_struct** %nn1, align 8
  store i32 0, i32* %index2, align 4
  br label %while30

while30:                                          ; preds = %merge50, %merge28
  %index154 = load i32, i32* %index1, align 4
  %lengthN255 = load i32, i32* %lengthN2, align 4
  %tmp56 = icmp slt i32 %index154, %lengthN255
  br i1 %tmp56, label %while_body31, label %merge57

while_body31:                                     ; preds = %while30
  %list32 = load %list_node*, %list_node** %nodes2, align 8
  %index233 = load i32, i32* %index2, align 4
  %malloccall34 = tail call i8* @malloc(i32 ptrtoint (%list_node** getelementptr (%list_node*, %list_node** null, i32 1) to i32))
  %22 = bitcast i8* %malloccall34 to %list_node**
  %malloccall35 = tail call i8* @malloc(i32 ptrtoint (i32* getelementptr (i32, i32* null, i32 1) to i32))
  %23 = bitcast i8* %malloccall35 to i32*
  store %list_node* %list32, %list_node** %22, align 8
  store i32 %index233, i32* %23, align 4
  br label %traverse_loop36

traverse_loop36:                                  ; preds = %while_body37, %while_body31
  %24 = load i32, i32* %23, align 4
  %temp41 = icmp ne i32 %24, 0
  br i1 %temp41, label %while_body37, label %merge42

while_body37:                                     ; preds = %traverse_loop36
  %25 = load %list_node*, %list_node** %22, align 8
  %temp38 = getelementptr inbounds %list_node, %list_node* %25, i32 0, i32 1
  %temp39 = load %list_node*, %list_node** %temp38, align 8
  %26 = load i32, i32* %23, align 4
  %subtract40 = sub i32 %26, 1
  store i32 %subtract40, i32* %23, align 4
  store %list_node* %temp39, %list_node** %22, align 8
  br label %traverse_loop36

merge42:                                          ; preds = %traverse_loop36
  %27 = load %list_node*, %list_node** %22, align 8
  %temp43 = getelementptr inbounds %list_node, %list_node* %27, i32 0, i32 0
  %retval44 = load i8*, i8** %temp43, align 8
  %li_conv45 = bitcast i8* %retval44 to %node_struct**
  %val_ptr46 = load %node_struct*, %node_struct** %li_conv45, align 8
  %nn2 = alloca %node_struct*, align 8
  store %node_struct* %val_ptr46, %node_struct** %nn2, align 8
  %nn247 = load %node_struct*, %node_struct** %nn2, align 8
  %nn148 = load %node_struct*, %node_struct** %nn1, align 8
  %edgeBetweenNodes_result = call i1 @edgeBetweenNodes(%node_struct* %nn148, %node_struct* %nn247)
  %isconnected = alloca i1, align 1
  store i1 %edgeBetweenNodes_result, i1* %isconnected, align 1
  %isconnected49 = load i1, i1* %isconnected, align 1
  br i1 %isconnected49, label %then51, label %else52

merge50:                                          ; preds = %else52, %then51
  %index253 = load i32, i32* %index2, align 4
  %tmp = add i32 %index253, 1
  store i32 %tmp, i32* %index2, align 4
  br label %while30

then51:                                           ; preds = %merge42
  store i1 true, i1* %connection, align 1
  br label %merge50

else52:                                           ; preds = %merge42
  br label %merge50

merge57:                                          ; preds = %while30
  %index158 = load i32, i32* %index1, align 4
  %tmp59 = add i32 %index158, 1
  store i32 %tmp59, i32* %index1, align 4
  br label %while

merge63:                                          ; preds = %while
  %connection64 = load i1, i1* %connection, align 1
  ret i1 %connection64
}
