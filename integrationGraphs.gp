...
merge359:                                         ; preds = %traverse_loop
  ...
  %printf361 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @fmt, i32 0, i32 0), i8* %assignment_name)
  ...
  store %node_node* %head364, %node_node** @llNodes.4, align 8
  br label %while365

while365:                                         ; preds = %merge359, %else372
  %putMeHere366 = load %node_node*, %node_node** @llNodes.4, align 8
  %curr367 = icmp ne %node_node* %putMeHere366, null
  br i1 %curr367, label %while_body368, label %merge373

while_body368:                                    ; preds = %while365
  %putMeHere369 = load %node_node*, %node_node** @llNodes.4, align 8
...
else372:                                          ; preds = %then371
  %toBeHere379 = load %node_node*, %node_node** @llNodes.4, align 8
  ...
  store %node_node* %toBeHerenow381, %node_node** @llNodes.4, align 8
  br label %while365
...
merge373:                                         ; preds = %while365
  ...
  %list382 = load %list_node*, %list_node** @allStudents, align 8
  %malloccall383 = tail call i8* @malloc(i32 ptrtoint (%list_node** getelementptr (%list_node*, %list_node** null, i32 1) to i32))
  %6 = bitcast i8* %malloccall383 to %list_node**
  %malloccall384 = tail call i8* @malloc(i32 ptrtoint (i32* getelementptr (i32, i32* null, i32 1) to i32))
  %7 = bitcast i8* %malloccall384 to i32*
  store %list_node* %list382, %list_node** %6, align 8
  store i32 0, i32* %7, align 4
  br label %traverse_loop385

traverse_loop385:                                 ; preds = %while_body386, %merge373
  %8 = load %list_node*, %list_node** %6, align 8
  %9 = icmp ne %list_node* %8, null
  br i1 %9, label %while_body386, label %merge389

while_body386:                                    ; preds = %traverse_loop385
  %10 = load %list_node*, %list_node** %6, align 8
  %temp387 = getelementptr inbounds %list_node, %list_node* %10, i32 0, i32 1
  %temp388 = load %list_node*, %list_node** %temp387, align 8
  %11 = load i32, i32* %7, align 4
  %add = add i32 %11, 1
  store i32 %add, i32* %7, align 4
  store %list_node* %temp388, %list_node** %6, align 8
  br label %traverse_loop385

merge389:                                         ; preds = %traverse_loop385
...
while390:                                         ; preds = %merge420, %merge389
  %i429 = load i32, i32* @i, align 4
  %num_students = load i32, i32* @num_students, align 4
  %tmp430 = icmp slt i32 %i429, %num_students
  br i1 %tmp430, label %while_body391, label %merge431

while_body391:                                    ; preds = %while390
  %sum = load i32, i32* @sum, align 4
  %curr392 = alloca i32, align 4
  store i32 %sum, i32* %curr392, align 4
  %list393 = load %list_node*, %list_node** @allStudents, align 8
  ...
  %13 = bitcast i8* %malloccall394 to %list_node**
  %malloccall395 = tail call i8* @malloc(i32 ptrtoint (i32* getelementptr (i32, i32* null, i32 1) to i32))
  %14 = bitcast i8* %malloccall395 to i32*
  store %list_node* %list393, %list_node** %13, align 8
  store i32 %i, i32* %14, align 4
  br label %traverse_loop396

traverse_loop396:                                 ; preds = %while_body397, %while_body391
  %15 = load i32, i32* %14, align 4
  %temp401 = icmp ne i32 %15, 0
...
while_body397:                                    ; preds = %traverse_loop396
  ...
  %temp398 = getelementptr inbounds %list_node, %list_node* %16, i32 0, i32 1
  %temp399 = load %list_node*, %list_node** %temp398, align 8
  %17 = load i32, i32* %14, align 4
  %subtract400 = sub i32 %17, 1
  store i32 %subtract400, i32* %14, align 4
  store %list_node* %temp399, %list_node** %13, align 8
  br label %traverse_loop396

merge402:                                         ; preds = %traverse_loop396
  %18 = load %list_node*, %list_node** %13, align 8
  %temp403 = getelementptr inbounds %list_node, %list_node* %18, i32 0, i32 0
  ...
  store %node_struct* %val_ptr406, %node_struct** %curr_student, align 8
  %"lvar'407" = load %node_struct*, %node_struct** %curr_student, align 8
  %temp408 = getelementptr inbounds %node_struct, %node_struct* %"lvar'407", i32 0, i32 2
  %curr_student.data = load i8*, i8** %temp408, align 8
  %new_ptr = bitcast i8* %curr_student.data to %list_node**
  %curr_student.data409 = load %list_node*, %list_node** %new_ptr, align 8
  %score_list = alloca %list_node*, align 8
  store %list_node* %curr_student.data409, %list_node** %score_list, align 8
  %list410 = load %list_node*, %list_node** %score_list, align 8
  %assignment_index411 = load i32, i32* @assignment_index, align 4
  %malloccall412 = tail call i8* @malloc(i32 ptrtoint (%list_node** getelementptr (%list_node*, %list_node** null, i32 1) to i32))
  %19 = bitcast i8* %malloccall412 to %list_node**
  %malloccall413 = tail call i8* @malloc(i32 ptrtoint (i32* getelementptr (i32, i32* null, i32 1) to i32))
  %20 = bitcast i8* %malloccall413 to i32*
  store %list_node* %list410, %list_node** %19, align 8
  store i32 %assignment_index411, i32* %20, align 4
  br label %traverse_loop414

traverse_loop414:                                 ; preds = %while_body415, %merge402
  %21 = load i32, i32* %20, align 4
  %temp419 = icmp ne i32 %21, 0
  br i1 %temp419, label %while_body415, label %merge420

while_body415:                                    ; preds = %traverse_loop414
  %22 = load %list_node*, %list_node** %19, align 8
  %temp416 = getelementptr inbounds %list_node, %list_node* %22, i32 0, i32 1
  %temp417 = load %list_node*, %list_node** %temp416, align 8
  %23 = load i32, i32* %20, align 4
  %subtract418 = sub i32 %23, 1
  store i32 %subtract418, i32* %20, align 4
  store %list_node* %temp417, %list_node** %19, align 8
  br label %traverse_loop414

merge420:                                         ; preds = %traverse_loop414
  %24 = load %list_node*, %list_node** %19, align 8
  %temp421 = getelementptr inbounds %list_node, %list_node* %24, i32 0, i32 0
  %retval422 = load i8*, i8** %temp421, align 8
  %li_conv423 = bitcast i8* %retval422 to i32*
  %val_ptr424 = load i32, i32* %li_conv423, align 4
  %score = alloca i32, align 4
  store i32 %val_ptr424, i32* %score, align 4
  %curr425 = load i32, i32* %curr392, align 4
  %score426 = load i32, i32* %score, align 4
  %tmp = add i32 %curr425, %score426
  store i32 %tmp, i32* @sum, align 4
  %i427 = load i32, i32* @i, align 4
  %tmp428 = add i32 %i427, 1
  store i32 %tmp428, i32* @i, align 4
  br label %while390

merge431:                                         ; preds = %while390
  %sum432 = load i32, i32* @sum, align 4
  %num_students433 = load i32, i32* @num_students, align 4
  %tmp434 = sdiv i32 %sum432, %num_students433
  store i32 %tmp434, i32* @average, align 4
  %average = load i32, i32* @average, align 4
  %printf435 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @fmt.5, i32 0, i32 0), i32 %average)
  ret i32 0
}
