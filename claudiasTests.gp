...
merge272:                                         ; preds = %while263
  ...
  br label %traverse_loop286

traverse_loop286:                                 ; preds = %while_body287, %merge272
  %14 = load %list_node*, %list_node** %12, align 8
  %15 = icmp ne %list_node* %14, null
  br i1 %15, label %while_body287, label %merge290

while_body287:                                    ; preds = %traverse_loop286
  %16 = load %list_node*, %list_node** %12, align 8
  %temp288 = getelementptr inbounds %list_node, %list_node* %16, i32 0, i32 1
  %temp289 = load %list_node*, %list_node** %temp288, align 8
  %17 = load i32, i32* %13, align 4
  %add = add i32 %17, 1
  store i32 %add, i32* %13, align 4
  store %list_node* %temp289, %list_node** %12, align 8
  br label %traverse_loop286

merge290:                                         ; preds = %traverse_loop286
  ...
  %printf291 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @fmt, i32 0, i32 0), i32 %list_length)
  ...
  %printf292 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @1, i32 0, i32 0))
  %total_weight = load i32, i32* @total_weight, align 4
  %printf293 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @fmt.6, i32 0, i32 0), i32 %total_weight)
  ret i32 0
}
